...
**Last Updated:** 27 February 2026 (Marketplace Flow Testing, Search Debugging & Job Lifecycle)
...
**New Enum** (`enums.ts`):
```typescript
coverageSelectionTypeEnum = pgEnum('mp_coverage_selection_type', ['DISTRICT', 'SUB_DISTRICT', 'VILLAGE'])
```
